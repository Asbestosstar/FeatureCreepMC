...
public class ArmourSetLapisBlock extends ItemArmor{
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, int layer) {
		...
		if(stack.toString().contains("Leggings")) if(itemID == featurecreep.FeatureCreepMC.LAPIS_LAZUI_LEGGINGS.itemID)
				{
			return "featurecreep:" + nametoadd + "_2.png";
				}
	...
	{
		if (itemID == FeatureCreepMC.LAPIS_LAZUI_HELMET.itemID) {
			itemIcon = par1iconRegister.registerIcon("featurecreep:lapis_block_helmet");
		}
if (itemID == FeatureCreepMC.LAPIS_LAZUI_CHESTPLATE.itemID) {
	itemIcon = par1iconRegister.registerIcon("featurecreep:lapis_block_chestplate");

		}
if (itemID == FeatureCreepMC.LAPIS_LAZUI_LEGGINGS.itemID) {
	itemIcon = par1iconRegister.registerIcon("featurecreep:lapis_block_leggings");

}
if (itemID == FeatureCreepMC.LAPIS_LAZUI_BOOTS.itemID) {
	itemIcon = par1iconRegister.registerIcon("featurecreep:lapis_block_boots");
