...
import featurecreep.armour.ArmourSetAluminium;
import featurecreep.armour.ArmourSetAmethyst;
import featurecreep.armour.ArmourSetCopper;
import featurecreep.armour.ArmourSetEmerald;
import featurecreep.armour.ArmourSetExperience;
import featurecreep.armour.ArmourSetLapisBlock;
import featurecreep.armour.ArmourSetLavaEel;
import featurecreep.armour.ArmourSetMobzilla;
import featurecreep.armour.ArmourSetMothScale;
import featurecreep.armour.ArmourSetPeckockFeather;
import featurecreep.armour.ArmourSetPinkTourmaline;
import featurecreep.armour.ArmourSetPlatinum;
import featurecreep.armour.ArmourSetQueen;
import featurecreep.armour.ArmourSetRoyal;
import featurecreep.armour.ArmourSetRuby;
import featurecreep.armour.ArmourSetSilver;
import featurecreep.armour.ArmourSetTigerEye;
import featurecreep.armour.ArmourSetTin;
import featurecreep.armour.ArmourSetUltimate;
import featurecreep.blocks.AluminiumBlock;
import featurecreep.blocks.AmethystBlock;
import featurecreep.blocks.RubyBlock;
import featurecreep.blocks.TigerEyeBlock;
import featurecreep.blocks.TitaniumBlock;
import featurecreep.blocks.UraniumBlock;
import featurecreep.ingots.Aluminium;
import featurecreep.ingots.Amethyst;
import featurecreep.ingots.Copper;
import featurecreep.ingots.PinkTourmaline;
import featurecreep.ingots.Platinum;
import featurecreep.ingots.Ruby;
import featurecreep.ingots.Silver;
import featurecreep.ingots.TigerEye;
import featurecreep.ingots.Tin;
import featurecreep.ingots.Titanium;
import featurecreep.ingots.TitaniumNugget;
import featurecreep.ingots.Uranium;
import featurecreep.ingots.UraniumNugget;
import featurecreep.ores.ALUMINIUMWORLDGEN;
import featurecreep.ores.AMETHYSTWORLDGEN;
import featurecreep.ores.AluminiumOre;
import featurecreep.ores.AmethystOre;
import featurecreep.ores.OILWORLDGEN;
import featurecreep.ores.OilOre;
import featurecreep.ores.RUBYWORLDGEN;
import featurecreep.ores.RubyOre;
import featurecreep.ores.SALTWORLDGEN;
import featurecreep.ores.SaltOre;
import featurecreep.ores.TIGERSEYEWORLDGEN;
import featurecreep.ores.TITANIUMWORLDGEN;
import featurecreep.ores.TigerEyeOre;
import featurecreep.ores.TitaniumOre;
import featurecreep.ores.URANIUMTWORLDGEN;
import featurecreep.ores.UraniumOre;
import featurecreep.tools.amethyst.AmethystAxe;
import featurecreep.tools.amethyst.AmethystHoe;
import featurecreep.tools.amethyst.AmethystPickaxe;
import featurecreep.tools.amethyst.AmethystShovel;
import featurecreep.tools.amethyst.AmethystSword;
import featurecreep.tools.emerald.EmeraldAxe;
import featurecreep.tools.emerald.EmeraldHoe;
import featurecreep.tools.emerald.EmeraldPickaxe;
import featurecreep.tools.emerald.EmeraldShovel;
import featurecreep.tools.emerald.EmeraldSword;
import featurecreep.tools.optimised.OptimisedPickaxe;
import featurecreep.tools.optimised.OptimisedShovel;
import featurecreep.tools.ruby.RubyAxe;
import featurecreep.tools.ruby.RubyHoe;
import featurecreep.tools.ruby.RubyPickaxe;
import featurecreep.tools.ruby.RubyShovel;
import featurecreep.tools.ruby.RubySword;
import featurecreep.tools.tigereye.TigerEyeAxe;
import featurecreep.tools.tigereye.TigerEyeHoe;
import featurecreep.tools.tigereye.TigerEyePic;
import featurecreep.tools.tigereye.TigerEyeShovel;
import featurecreep.tools.tigereye.TigerEyeSword;
import featurecreep.tools.ultimate.UltimateAxe;
import featurecreep.tools.ultimate.UltimateHoe;
import featurecreep.tools.ultimate.UltimatePickaxe;
import featurecreep.tools.ultimate.UltimateShovel;
import featurecreep.tools.ultimate.UltimateSword;
...
import featurecreep.items.*;

@Mod(modid = "featurecreep", name = "Feature Creep", version = "0,0,6 Alpha")
@NetworkMod(clientSideRequired = true, serverSideRequired = false)


public class FeatureCreepMC {
@SidedProxy (clientSide = "featurecreep.ClientProxy", serverSide = "featurecreep.CommonProxy")
...
public static Item MobzillaScale = new MobzillaScale(6029).setUnlocalizedName("mobzilla_scale");
public static Item QueenScale = new QueenScale(MinItemID + 453).setUnlocalizedName("queen_scale");
public static Item MothScale = new MothScale(MinItemID + 156).setUnlocalizedName("moth_scale");
...
public static EnumArmorMaterial ArmourSilver = EnumHelper.addArmorMaterial("Silver", 30, new int [] {5, 10, 10,5}, 30);
public static EnumArmorMaterial ArmourPlatinum = EnumHelper.addArmorMaterial("Platinum", 20, new int [] {4, 15, 15,10}, 30);
...
public static Item COPPER_HELMET = new ArmourSetCopper(6012, ArmourCopper, 0, 0, "COPPER").setUnlocalizedName("copper_helmet"); 
public static Item COPPER_CHESTPLATE = new ArmourSetCopper(6013, ArmourCopper, 0, 1, "COPPER").setUnlocalizedName("copper_chestplate"); 
public static Item COPPER_LEGGINGS = new ArmourSetCopper(6014, ArmourCopper, 0, 2, "COPPER").setUnlocalizedName("copper_leggings"); 
public static Item COPPER_BOOTS = new ArmourSetCopper(6015, ArmourCopper, 0, 3, "COPPER").setUnlocalizedName("copper_boots"); 
...
proxy.registerRenderInformation();	
	...
	{
		GameRegistry.registerWorldGenerator(AluminiumWorldGen);
		GameRegistry.registerWorldGenerator(AmethystWorldGen);
GameRegistry.registerWorldGenerator(OilWorldGen);
GameRegistry.registerWorldGenerator(RubyWorldGen);
GameRegistry.registerWorldGenerator(SALTWorldGen);
GameRegistry.registerWorldGenerator(TigersEyeWorldGen);
GameRegistry.registerWorldGenerator(TitaniumWorldGen);
GameRegistry.registerWorldGenerator(UraniumWorldGen);
...
//ItemStack experienceboots = new ItemStack(featurecreep.EXPERIENCE_BOOTS);
...
GameRegistry.addRecipe(new ItemStack (PEACOCK_FEATHER_HELMET, 1), new Object [] {
		"XXX", "X X", "   ", 'X', featurecreep.FeatureCreepMC.PEACKOCK_FEATHER	
});

GameRegistry.addRecipe(new ItemStack (PEACOCK_FEATHER_CHESTPLATE, 1), new Object [] {
		"X X", "XXX", "XXX", 'X', featurecreep.FeatureCreepMC.PEACKOCK_FEATHER		
});
GameRegistry.addRecipe(new ItemStack (PEACOCK_FEATHER_LEGGINGS, 1), new Object [] {
		"XXX", "X X", "X X", 'X', featurecreep.FeatureCreepMC.PEACKOCK_FEATHER	
});
...
GameRegistry.addRecipe(new ItemStack (SILVER_HELMET, 1), new Object [] {
		"XXX", "X X", "   ", 'X', featurecreep.FeatureCreepMC.SILVER_INGOT	
});
	
GameRegistry.addRecipe(new ItemStack (SILVER_CHESTPLATE, 1), new Object [] {
		"X X", "XXX", "XXX", 'X', featurecreep.FeatureCreepMC.SILVER_INGOT			
});


GameRegistry.addRecipe(new ItemStack (SILVER_LEGGINGS, 1), new Object [] {
		"XXX", "X X", "X X", 'X', featurecreep.FeatureCreepMC.SILVER_INGOT			
});
	
GameRegistry.addRecipe(new ItemStack (SILVER_BOOTS, 1), new Object [] {
"   ", "X X", "X X", 'X', featurecreep.FeatureCreepMC.SILVER_INGOT		
});
...
GameRegistry.addRecipe(new ItemStack (TIN_HELMET, 1), new Object [] {
		"XXX", "X X", "   ", 'X', featurecreep.FeatureCreepMC.TIN_INGOT	
});
	
GameRegistry.addRecipe(new ItemStack (TIN_CHESTPLATE, 1), new Object [] {
		"X X", "XXX", "XXX", 'X', featurecreep.FeatureCreepMC.TIN_INGOT			
});


GameRegistry.addRecipe(new ItemStack (TIN_LEGGINGS, 1), new Object [] {
		"XXX", "X X", "X X", 'X', featurecreep.FeatureCreepMC.TIN_INGOT			
});
	
GameRegistry.addRecipe(new ItemStack (TIN_BOOTS, 1), new Object [] {
"   ", "X X", "X X", 'X', featurecreep.FeatureCreepMC.TIN_INGOT		
});
...
"X X", "X X", "   ", 'X', featurecreep.FeatureCreepMC.PLATINUM_INGOT	
});
	
GameRegistry.addRecipe(new ItemStack (PLATINUM_CHESTPLATE, 1), new Object [] {
		"X X", "XXX", "XXX", 'X', featurecreep.FeatureCreepMC.PLATINUM_INGOT			
});


GameRegistry.addRecipe(new ItemStack (PLATNIUM_LEGGINGS, 1), new Object [] {
		"XXX", "X X", "X X", 'X', featurecreep.FeatureCreepMC.PLATINUM_INGOT			
});
