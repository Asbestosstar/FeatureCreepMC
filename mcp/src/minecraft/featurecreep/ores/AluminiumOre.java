...
public class AluminiumOre extends Block{
	...
	public AluminiumOre(int p_i2273_1_, Material p_i2273_2_) {
...
{
blockIcon = iconRegister.registerIcon("featurecreep:aluminium_ore");	
}
	
public int idDropped(int par1, Random par2Random, int par3)
{
	return featurecreep.FeatureCreepMC.ALUMINIUM_ORE.blockID;
}
