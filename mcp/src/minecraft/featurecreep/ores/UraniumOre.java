...
public class UraniumOre extends Block{
	...
	public UraniumOre(int p_i2273_1_, Material p_i2273_2_) {
...
{
blockIcon = iconRegister.registerIcon("featurecreep:uranium_ore");	
}
	
public int idDropped(int par1, Random par2Random, int par3)
{
	return featurecreep.FeatureCreepMC.URANIUM_ORE.blockID;
}
