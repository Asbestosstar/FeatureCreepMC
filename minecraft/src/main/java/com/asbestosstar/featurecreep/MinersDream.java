			...
			for(int x = minx; x <= maxx; x++) {
				for(int y = miny; y <= maxy; y++) {
					for(int z = minz; z <= maxz; z++) {
						...
						if(		world.getBlockState(blockPosition0) == Blocks.STONE.getDefaultState() || world.getBlockState(RemovePos) == Blocks.SANDSTONE.getDefaultState() || world.getBlockState(RemovePos) == Blocks.STONE.getStateFromMeta(0) || world.getBlockState(RemovePos) == Blocks.STONE.getStateFromMeta(1) || world.getBlockState(RemovePos) == Blocks.STONE.getStateFromMeta(2) || world.getBlockState(RemovePos) == Blocks.STONE.getStateFromMeta(3) || world.getBlockState(RemovePos) == Blocks.STONE.getStateFromMeta(4) || world.getBlockState(RemovePos) == Blocks.STONE.getStateFromMeta(5) || world.getBlockState(RemovePos) == Blocks.STONE.getStateFromMeta(6) || world.getBlockState(RemovePos) == Blocks.STONE.getStateFromMeta(7) || world.getBlockState(RemovePos) == Blocks.STONE.getStateFromMeta(8) || world.getBlockState(RemovePos) == Blocks.WATER.getDefaultState()) {
