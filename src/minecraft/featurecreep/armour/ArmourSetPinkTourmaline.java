...
public class ArmourSetPinkTourmaline extends ItemArmor{
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, int layer) {
		...
		if(stack.toString().contains("Leggings")) if(itemID == featurecreep.FeatureCreepMC.PINK_TOURMALINE_LEGGINGS.itemID)
				{
			return "featurecreep:" + nametoadd + "_2.png";
				}
	...
	{
		if (itemID == FeatureCreepMC.PINK_TOURMALINE_HELMET.itemID) {
			itemIcon = par1iconRegister.registerIcon("featurecreep:pink_tourmaline_helmet");
		}
if (itemID == FeatureCreepMC.PINK_TOURMALINE_CHESTPLATE.itemID) {
	itemIcon = par1iconRegister.registerIcon("featurecreep:pink_tourmaline_chestplate");

		}
if (itemID == FeatureCreepMC.PINK_TOURMALINE_LEGGINGS.itemID) {
	itemIcon = par1iconRegister.registerIcon("featurecreep:pink_tourmaline_leggings");

}
if (itemID == FeatureCreepMC.PINK_TOURMALINE_BOOTS.itemID) {
	itemIcon = par1iconRegister.registerIcon("featurecreep:pink_tourmaline_boots");
