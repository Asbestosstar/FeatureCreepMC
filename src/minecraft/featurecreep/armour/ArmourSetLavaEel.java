...
public class ArmourSetLavaEel extends ItemArmor{
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, int layer) {
		...
		if(stack.toString().contains("Leggings")) if(itemID == featurecreep.FeatureCreepMC.LAVA_EEL_LEGGINGS.itemID)
				{
			return "featurecreep:" + nametoadd + "_2.png";
				}
	...
	{
		if (itemID == FeatureCreepMC.LAVA_EEL_HELMET.itemID) {
			itemIcon = par1iconRegister.registerIcon("featurecreep:lava_eel_helmet");
		}
if (itemID == FeatureCreepMC.LAVA_EEL_CHESTPLATE.itemID) {
	itemIcon = par1iconRegister.registerIcon("featurecreep:lava_eel_chestplate");

		}
if (itemID == FeatureCreepMC.LAVA_EEL_LEGGINGS.itemID) {
	itemIcon = par1iconRegister.registerIcon("featurecreep:lava_eel_leggings");

}
if (itemID == FeatureCreepMC.LAVA_EEL_BOOTS.itemID) {
	itemIcon = par1iconRegister.registerIcon("featurecreep:lava_eel_boots");
