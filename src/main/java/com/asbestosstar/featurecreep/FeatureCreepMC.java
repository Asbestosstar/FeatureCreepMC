...
public static final Item TITANIUM_NUGGET = new Amathest("titaniumnugget");
...
public static final Block AMETHYST_ORE = new GemOre("amethyst_ore", Material.IRON, 4, 5, 3, null, DimensionType.OVERWORLD, 16, 200, 5, 20,BlockMatcher.forBlock(Blocks.STONE), FeatureCreepMC.AMETHYST);
public static final Block RUBY_ORE = new GemOre("ruby_ore", Material.IRON, 4, 5, 3, null, DimensionType.OVERWORLD, 16, 200, 5, 20,BlockMatcher.forBlock(Blocks.STONE), FeatureCreepMC.RUBY);
public static final Block ALUMINIUM_ORE = new IngotOre("aluminium_ore", Material.IRON, 4, 5, 3, null, DimensionType.OVERWORLD, 16, 200, 7, 20,BlockMatcher.forBlock(Blocks.STONE));
public static final Block TIGERS_EYE_ORE = new IngotOre("tigers_eye_ore", Material.IRON, 4, 5, 3, null, DimensionType.OVERWORLD, 16, 200, 5, 20,BlockMatcher.forBlock(Blocks.STONE));
public static final Block TITANIUM_ORE = new IngotOre("titanium_ore", Material.IRON, 4, 5, 3, null, DimensionType.OVERWORLD, 16, 200, 4, 20,BlockMatcher.forBlock(Blocks.STONE));
public static final Block URANIUM_ORE = new IngotOre("uranium_ore", Material.IRON, 4, 5, 3, null, DimensionType.OVERWORLD, 16, 200, 3, 5,BlockMatcher.forBlock(Blocks.STONE));
public static final Block UNPROCESSED_OIL_ORE = new DustOre("unprocessed_oil_ore", Material.IRON, 4, 5, 3, null, DimensionType.OVERWORLD, 16, 200, 50, 20,BlockMatcher.forBlock(Blocks.STONE), FeatureCreepMC.Oil);
public static final Block SALT_ORE = new DustOre("salt_ore", Material.IRON, 4, 5, 3, null, DimensionType.OVERWORLD, 16, 200, 8, 20,BlockMatcher.forBlock(Blocks.STONE), FeatureCreepMC.Oil);
